...
def measure_current_and_get_dac(message):
    while True:
        ...
        print("Calculated DAC value for {} current: {}".format(message, dac_value))
...
dac_4 = measure_current_and_get_dac("4mA")

# Measure and get DAC value for 20mA current
dac_20 = measure_current_and_get_dac("20mA")
